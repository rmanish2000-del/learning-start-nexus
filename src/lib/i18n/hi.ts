...
Object.assign(HI, {
  ...
  // ------------------------------------------- learner handoff & free check
  "learner.exitResume": "बाहर निकलें, बाद में जारी रखें",
  "learner.focusMode": "फ़ोकस मोड — उत्तर अपने आप सेव होते हैं। कभी भी रुककर लौट सकते हैं।",
  "common.help": "सहायता",
  "learners.title": "आपके बच्चे",
  "learners.subtitle": "बच्चा जोड़िए, उसका लॉगिन साझा कीजिए, मुफ़्त लर्निंग चेक कराइए और हर जाँच की स्थिति देखिए।",
  "learners.empty.title": "शुरू करने के लिए अपने बच्चे को जोड़ें",
  "learners.empty.body": "प्रोफ़ाइल बनाने में कुछ सेकंड लगते हैं और यह मुफ़्त है। लॉगिन हैंडल तुरंत मिल जाता है और खरीदने से पहले मुफ़्त लर्निंग चेक करा सकते हैं।",
  "learners.add": "बच्चा जोड़ें",
  "learners.add.name": "बच्चे का पूरा नाम",
  "learners.add.scope": "पायलट में CBSE कक्षा 10 — गणित और विज्ञान शामिल हैं।",
  "learners.diagnostics": "जाँच",
  "learners.diagnostics.none": "अभी तक कोई भुगतान की गई जाँच नहीं है।",
  "learners.signInDetails": "साइन-इन विवरण",
  "status.notStarted": "शुरू नहीं हुई",
  "status.inProgress": "चल रही है",
  "status.completed": "पूरी — रिपोर्ट तैयार",
  "freeCheck.title": "मुफ़्त लर्निंग चेक",
  "freeCheck.body": "5 प्रश्न, हर विषय में एक बार, कोई भुगतान नहीं। आपका बच्चा इसे अपने स्टूडेंट खाते से हल करता है।",
  "freeCheck.start": "मुफ़्त चेक शुरू करें",
  "freeCheck.notStarted": "शुरू नहीं हुई। हर विषय में एक ही मुफ़्त चेक।",
  "freeCheck.waiting": "आपके बच्चे के उत्तर का इंतज़ार है।",
  "freeCheck.skills": "जाँचे गए कौशल",
  "freeCheck.gaps": "संभावित कमियाँ:",
  "freeCheck.noGaps": "इस छोटी जाँच में कोई कमी नहीं मिली।",
  "freeCheck.sample": "नमूना सुझाव: ",
  "freeCheck.previewNote": "यह केवल झलक है — एक अध्याय समूह के 20 में से 5 प्रश्न। ₹199 की जाँच पूरी लक्ष्य-वार रिपोर्ट देती है।",
  "freeCheck.compare": "₹199 की जाँच में और क्या मिलता है",
  "freeCheck.complete": "लर्निंग चेक पूरा हुआ",
  "freeCheck.finish": "चेक पूरा करें",
  "handoff.ready": "{name} के लिए जाँच तैयार है",
  "handoff.paid": "भुगतान मिल गया",
  "handoff.ask": "{name} से साइन इन करने को कहें",
  "handoff.handle": "हैंडल",
  "handoff.pinSet": "आपके द्वारा तय किया गया 6 अंकों का पिन। इसे अभिभावक पोर्टल से कभी भी बदल सकते हैं।",
  "handoff.pinMissing": "अभी तय नहीं हुआ — बच्चे के साइन इन करने से पहले अभिभावक पोर्टल में 6 अंकों का पिन तय करें।",
  "handoff.law": "आपका बच्चा जाँच अपने स्टूडेंट खाते में हल करता है, ताकि परिणाम उसी का हो। पूरा होते ही रिपोर्ट यहीं मिल जाएगी।",
  "handoff.openSignIn": "स्टूडेंट साइन-इन खोलें",
  "handoff.backToPortal": "अभिभावक पोर्टल पर लौटें",
  "handoff.openReport": "रिपोर्ट खोलें",
  "handoff.copy": "लॉगिन निर्देश कॉपी करें",
  "handoff.print": "प्रिंट करें",
  "runs.title": "आपके लिए असाइनमेंट",
  "runs.subtitle": "उत्तर अपने आप सेव होते हैं — आप रुककर बाद में लौट सकते हैं।",
  "runs.startDiagnostic": "जाँच शुरू करें",
  "runs.resumeDiagnostic": "जाँच जारी रखें",
  "runs.startFreeCheck": "मुफ़्त चेक शुरू करें",
  "runs.resumeFreeCheck": "चेक जारी रखें",
  "runs.viewConfirmation": "पुष्टि देखें",
  "runs.done.title": "बहुत बढ़िया — हो गया",
  "runs.done.body": "आपकी जाँच जमा हो गई है। रिपोर्ट आपके अभिभावक को मिलेगी और आपके फ़ोकस क्षेत्र My Learning में दिखेंगे।",
  "runs.backToLearning": "My Learning पर लौटें",
});
