...
Object.assign(HI, {
  ...
  "portal.checklist.body": "आपके परिवार का अनुभव तैयार करने के लिए दो छोटे कदम।",
  "portal.step.progress.body": "जीवंत महारत, हाल की जाँच के अंक और चालू अभ्यास देखिए।",
  "portal.child.one": "आपका बच्चा",
  "portal.child.many": "आपके बच्चे",
  "portal.children.error": "हम आपके बच्चों की जानकारी नहीं ला सके",
  "portal.children.empty.title": "अभी कोई बच्चा जुड़ा नहीं है",
  "portal.children.empty.body":
    "आपका खाता किसी विद्यार्थी से जुड़ा नहीं है। अपने सेंटर के व्यवस्थापक से कहिए कि आपके बच्चे को इस खाते से जोड़ दें।",
  "portal.children.empty.hint": "जुड़ते ही प्रगति और अनुमति के नियंत्रण यहाँ अपने आप दिखने लगेंगे।",
  "pay.cancelled": "भुगतान रद्द हुआ। कोई राशि नहीं ली गई।",
  "pay.secureNote": "भुगतान Razorpay द्वारा सुरक्षित रूप से लिया जाता है। EduOS आपके कार्ड की जानकारी न देखता है न रखता है।",
  "upgrade.activated": "पूर्ण सफलता योजना चालू हो गई।",
  "upgrade.unlock.title": "आज से क्या बदलेगा",
  "upgrade.pay.perYear": "प्रति वर्ष · हर साल नवीनीकरण",
  "upgrade.pay.creditLine": "पहले साल के लिए · {credit} की जाँच राशि घटाई गई · नवीनीकरण {renew}/वर्ष",
  "upgrade.pay.creditWindow":
    "यह छूट अगले {days} दिन तक उपलब्ध है। उसके बाद योजना {price} की होगी, बिना किसी छूट के।",
  "upgrade.trust.0": "कभी भी बंद कीजिए, अवधि पूरी होने तक सुविधा चलती रहेगी",
  "upgrade.trust.1": "EduOS कोई कार्ड सहेजकर नहीं रखता",
  "upgrade.trust.2": "कहने पर डेटा हटा दिया जाता है",
  "upgrade.trust.sibling": "भाई-बहन योजना {price}",
});
